...
class _TrackingPageState extends State<TrackingPage> {
  final List<Location> locations = [
    Location('Arusha Facility', DateTime(2019, 6, 5, 5, 23, 4), showHour: false, isHere: false, passed: true),
    Location('Dar es Salaam Facility', DateTime(2019, 6, 6, 5, 23, 4), showHour: false, isHere: false, passed: true),
    Location(
      'Dodoma Facility',
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(color: Colors.grey[100], image: DecorationImage(image: AssetImage('assets/images/Group 444.png'), fit: BoxFit.contain)),
      child: Container(
                  ...
                  children: <Widget>[
                    ...
                    SingleChildScrollView(
                      child: ConstrainedBox(
                        ...
                        child: Theme(
                          data: ThemeData(primaryColor: Colors.yellow, fontFamily: 'Montserrat'),
                          child: Stepper(
