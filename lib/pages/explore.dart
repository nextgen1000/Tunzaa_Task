...
import 'package:tunzaa/pages/product_view.dart';
...
class _ExplorePageState extends State<ExplorePage> with TickerProviderStateMixin {
        ...
        SliverAppBar(
          ...
          flexibleSpace: FlexibleSpaceBar(
            ...
            title: AnimatedOpacity(
              ...
              child: FadeAnimation(1, Text("Find your 2023 Collections",
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 28.0,
                ))),
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return productCart(fetchProducts[index]);
                      }
                    )
                  )
                ]
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemCount: fetchProducts.length,
                      itemBuilder: (context, index) {
                        return forYou(fetchProducts[index]);
                      }
                    )
                  )
                ]
  ...
  if (response.statusCode == 200) {
    ...
    for (var json in jsonList) {
      product.add(Product.fromJson(json));
    }
    return product;
  } else {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(product.category, style: TextStyle(color: Colors.orange.shade400, fontSize: 14,),),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5,),
                  Text(product.title, style: TextStyle(color: Colors.orange.shade400, fontSize: 13,),),
                  SizedBox(height: 10,),
                  Text("\$ " +product.price.toString() + '.00',
                    style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w800),
                  ),
